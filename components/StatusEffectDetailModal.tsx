    ...
    >
      ...
      >
        ...
        <div className="p-6 font-serif flex-grow flex flex-col items-center">
          ...
          <h3 className="text-3xl font-bold text-white text-center">{effect.name || '未知状态'}</h3>
          <p className="text-lg text-amber-400 font-mono mt-1 mb-6">剩余 {effect.duration ?? 0} 回合</p>
          ...
          <div className="w-full space-y-4 text-left">
            <div className="bg-black/20 p-3 rounded-md border border-stone-700/50">
              ...
              <p className="text-gray-300 leading-relaxed text-base">{effect.description || '无描述'}</p>
            </div>
