...
const ActionNarrator: React.FC<ActionNarratorProps> = ({ descriptions, isLoading, isPlayerTurn }) => {
    ...
    return (
        <div className="w-full min-h-[6rem] bg-slate-900/50 p-4 rounded-lg border border-slate-700/50 flex flex-col justify-center items-center text-gray-300 font-serif transition-all duration-300 text-base shadow-inner shadow-black/50">
